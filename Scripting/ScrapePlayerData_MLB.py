...
def writePlayerDataToCsvMLB():

    teamsUrl = 'http://site.api.espn.com/apis/site/v2/sports/baseball/mlb/teams'
    ...
    teamBaseUrl = 'http://site.api.espn.com/apis/site/v2/sports/baseball/mlb/teams/'
    print(teamBaseUrl)
    ...
    with open( ('Scripting/csv/Player_baseball.csv'), 'w', newline='' )as output_file:
